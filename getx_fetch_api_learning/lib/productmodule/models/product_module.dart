...
List<ProductModel> productFromMap(String str) => List<ProductModel>.from(json.decode(str).map((x) => ProductModel.fromMap(x)));

String productToMap(List<ProductModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toMap())));
...
class ProductModel {
    ...
    factory ProductModel.fromMap(Map<String, dynamic> json) => ProductModel(
        ...
        productColors: List<ProductColor>.from(json["product_colors"].map((x) => ProductColor.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "product_colors": List<dynamic>.from(productColors.map((x) => x.toMap())),
    };
}
